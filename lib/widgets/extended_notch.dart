...
class ExtendedNotch implements NotchedShape {
  ...
  Path getOuterPath(Rect host, Rect guest) {
    ...
    // p3, p4, and p5 are the control points for segment C, which is a mirror
    ...
    Path path = Path();
      ...
      if(guest.height == guest.width){ 
        ...
        path
        ..arcToPoint( guest.bottomLeft + Offset(guest.height / 2, 0) , radius: Radius.circular(guest.height /2),  clockwise: false,)
        ..lineTo(guest.right - guest.height / 2, guest.bottom)
        ..arcToPoint( p[3],radius: Radius.circular(guest.height /2),  clockwise: false,);
      }  
      // C
      path
